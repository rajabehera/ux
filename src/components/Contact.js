            ...
            <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
                    ...
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="relative space-y-6">
                            ...
                            <button
                                ...
                                className="group relative w-full md:w-auto px-12 py-4  bg-gradient-to-r from-pink-500 to-purple-500 text-white text-sm uppercase tracking-widest hover:opacity-90 transition-opacity text-white font-bold uppercase tracking-widest overflow-hidden transition-all duration-300 hover:shadow-2xl"
                            >
                ...
                <div className="py-12" data-aos="fade-up">
                    <div className="text-center mb-12">
                        <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">Digital Footprint</h3>
